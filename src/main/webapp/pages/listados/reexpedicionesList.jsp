...
<s:set var="titulo" value="cabecera.listado.peticiones_reexpediciones" />
<s:set var="contenido" />
...
<script type="text/javascript">
	...
	function filtra(pagina){
		...
		$.post('lista_reexpediciones', datos, function(data){
...
<div id="seccion" style="margin-top: 25px;">
	<s:text name="cabecera.listado.peticiones_reexpediciones"></s:text>
</div>
